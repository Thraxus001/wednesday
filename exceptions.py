...
EXCEPTION_TYPES['MemoryConsolidationError'] = ExceptionFactory.create_exception_type(
    'MemoryConsolidationError',
    base=EXCEPTION_TYPES['MemoryError'],
    docstring="Memory consolidation error."
)
...
# Make all exception types available for import
globals().update(EXCEPTION_TYPES)
